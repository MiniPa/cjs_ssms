...
<nav class="navbar navbar-default navbar-inverse navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<%=path %>/index/turnToIndex/1"> </a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="demo-navbar">
          ...
          <form class="navbar-form navbar-left" action="<%=path %>/q" method="post" role="search">
                  ...
                  <c:otherwise>
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li>
                          <a href="<%=path%>/user/frontUserSet/${user.id}">${user.username }
                            <span class="glyphicon glyphicon-cog"></span>
                          </a>
                          <a href="<%=path %>/login/loginOut?type=1">退出登录
