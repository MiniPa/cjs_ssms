  ...
  <div class="container">
    ...
    <div class="navbar-header">
      <button type="button" class="navbar-toggle collapsed"
              data-toggle="collapse" data-target="#demo-navbar" aria-expanded="false">
        <span class="sr-only">Toggle navigation</span>
        <span class="icon-bar"></span>
        <span class="icon-bar"></span>
        <span class="icon-bar"></span>
      </button>
      <a class="navbar-brand" href="<%=path %>/index/turnToWebSocketIndex/1"> </a>
    </div>

    <div class="collapse navbar-collapse" id="demo-navbar">
      <ul class="nav navbar-nav">
        <li class="active">
          <a title="COJ" href="<%=path %>/index">
      ...
      <form class="navbar-form navbar-left" action="<%=path %>/queryLuceneByKey" method="post" role="search">
        <div class="form-group">
          <input type="text" name="query_key" class="form-control" placeholder="Search">
        </div>
